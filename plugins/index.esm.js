...
const ActiveElementPlugin = {
    install(app) {
        ...
        app.provide(ACTIVE_ELEMENT_TOKEN, readonly(activeElement));
    },
};
...
const SelectionChangePlugin = {
    install(app) {
        const selectionEvent = ref(null);
        const selectionChange = (event) => {
            selectionEvent.value = event;
        };
        document.addEventListener("selectionchange", selectionChange);
        app.provide(SELECTION_CHANGE_TOKEN, readonly(selectionEvent));
    },
};

export { ActiveElementPlugin, SelectionChangePlugin };
