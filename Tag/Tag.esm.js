import { defineComponent, toRefs, ref, resolveComponent, openBlock, createElementBlock, normalizeClass, withKeys, createElementVNode, renderSlot, withModifiers, createVNode, createCommentVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("button", {
    ...
    onKeydown: [
      _cache[2] || (_cache[2] = withKeys((...args) => (_ctx.remove && _ctx.remove(...args)), ["backspace"])),
      _cache[3] || (_cache[3] = withKeys((...args) => (_ctx.remove && _ctx.remove(...args)), ["esc"]))
    ]
  }, [
    createElementVNode("span", {
      class: normalizeClass([_ctx.$style.content, _ctx.removable && _ctx.$style.content_removable])
    }, [
    ...
    (_ctx.removable)
      ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass(_ctx.$style.iconContainer),
          onClick: _cache[0] || (_cache[0] = withModifiers((...args) => (_ctx.remove && _ctx.remove(...args)), ["stop","prevent"]))
        }, [
