import { defineComponent, inject, toRefs, computed, openBlock, createElementBlock, normalizeClass, Fragment, renderList, normalizeStyle, createElementVNode } from 'vue';
...
var script = defineComponent({
    ...
    setup(props) {
        const authSwitchingProgress = inject(EVENT_TUNNEL_PROGRESS_TOKEN, null);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("div", {
    ...
    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.length, (index) => {
