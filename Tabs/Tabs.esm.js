import { defineComponent, openBlock, createElementBlock, normalizeClass, Fragment, renderList, renderSlot } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("ul", {
    class: normalizeClass([_ctx.$style.tabs, _ctx.$style['tabs_' + _ctx.size]])
  }, [
    (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.tabs, (tab) => {
      return (openBlock(), createElementBlock("li", {
        ...
        renderSlot(_ctx.$slots, "default", { tab: tab })
      ], 10, _hoisted_1))
    }), 128))
  ], 2))
}
