...
this.smartmed.BaseCheckbox = (function (vue, application, SvgIcon) {
  'use strict';
    ...
    return (vue.openBlock(), vue.createElementBlock("label", {
      ...
      vue.createElementVNode("div", {
        ...
        vue.createElementVNode("input", {
          ref: "native",
          type: "checkbox",
          class: vue.normalizeClass(_ctx.$style.input),
          id: _ctx.id,
        ...
        vue.createElementVNode("div", {
          ...
          vue.createVNode(_component_svg_icon, {
            size: _ctx.size,
            name: _ctx.icon,
            class: vue.normalizeClass(_ctx.$style.iconComponent)
          }, null, 8, ["size", "name", "class"])
        ], 2),
        (_ctx.$slots.default)
          ? (vue.openBlock(), vue.createElementBlock("span", {
              key: 0,
              class: vue.normalizeClass([_ctx.$style.text, _ctx.$style['text_' + _ctx.size]])
            }, [
...
})(Vue, smartmed.application, SvgIcon);
