import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, createBlock, createCommentVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_lock_icon = resolveComponent("lock-icon");
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", {
      ...
      createElementVNode("div", {
        ...
        (_ctx.disabled)
          ? (openBlock(), createBlock(_component_lock_icon, {
              key: 0,
              width: "100%",
              height: "100%"
            }))
