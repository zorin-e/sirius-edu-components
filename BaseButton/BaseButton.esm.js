import { defineComponent, toRefs, ref, useCssModule, computed, resolveComponent, openBlock, createElementBlock, normalizeClass, renderSlot, createCommentVNode, createTextVNode, toDisplayString, createBlock } from 'vue';
  ...
  return (openBlock(), createElementBlock("button", {
    ...
    (_ctx.hasLeftIcon)
      ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass([_ctx.$style.icon, _ctx.$style.element])
        }, [
    ...
    ((_ctx.$slots.default || _ctx.title) && !_ctx.iconButton)
      ? (openBlock(), createElementBlock("span", {
          key: 1,
          class: normalizeClass([_ctx.$style.content, _ctx.$style.element])
        }, [
    ...
    (_ctx.hasRightIcon)
      ...
      : createCommentVNode("", true),
    (_ctx.isLoading)
      ? (openBlock(), createBlock(_component_spinner, {
          key: 3,
