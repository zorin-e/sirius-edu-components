import { defineComponent, toRefs, ref, computed, resolveComponent, openBlock, createElementBlock, normalizeClass, withModifiers, toDisplayString, createCommentVNode, createElementVNode, renderSlot, createVNode, createBlock } from 'vue';
import MaskedInput from '@smartmed/webpatient-vue-components/MaskedInput';
import { useInteractive, useModelModifiers } from '@smartmed/webpatient-vue-components/application';
...
var script = defineComponent({
    ...
    setup(props, { emit, slots }) {
        const { modelValue, modelModifiers, editable, isSuccess, isError, hasCleaner, size, } = toRefs(props);
        const showPass = ref(false);
        const interactive = useInteractive();
        const modifiers = useModelModifiers(modelModifiers.value);
        const isValue = computed(() => !!modelValue.value && String(modelValue.value).length > 0);
        const iconSize = computed(() => {
            return size.value === "sm" ? "md" : "lg";
        });
        const computedHasValueContent = computed(() => hasSlotContent(slots.valueContent));
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_masked_input = resolveComponent("masked-input");
  const _component_svg_icon = resolveComponent("svg-icon");

  return (openBlock(), createElementBlock("label", {
    class: normalizeClass([_ctx.$style.input, _ctx.readonly && _ctx.$style.input_readonly]),
    for: _ctx.id
  }, [
    (!!_ctx.label)
      ? (openBlock(), createElementBlock("span", {
          ...
          class: normalizeClass([_ctx.$style.label, 'smed-text_body-sm']),
    ...
    createElementVNode("div", {
      ...
      (_ctx.hasLeftSlot)
        ? (openBlock(), createElementBlock("div", {
            ...
            class: normalizeClass([_ctx.$style.icon, _ctx.$style.iconsLeft, _ctx.$style.icon_left])
          }, [
            renderSlot(_ctx.$slots, "left", { size: _ctx.iconSize })
          ], 2))
        : createCommentVNode("", true),
      createElementVNode("div", {
        class: normalizeClass(_ctx.$style.nativeWrapper)
      }, [
        createVNode(_component_masked_input, {
      ...
      (_ctx.hasRightIcons)
        ? (openBlock(), createElementBlock("div", {
            key: 1,
            class: normalizeClass(_ctx.$style.iconsRight)
          }, [
            (_ctx.isError)
              ? (openBlock(), createBlock(_component_svg_icon, {
                  ...
                  name: "close-filled",
                  class: normalizeClass([_ctx.$style.icon, _ctx.$style.icon_right, _ctx.$style.icon_error]),
                  size: _ctx.iconSize
                }, null, 8, ["class", "size"]))
              : createCommentVNode("", true),
            (_ctx.isSuccess)
              ? (openBlock(), createBlock(_component_svg_icon, {
                  ...
                  name: "check-filled",
                  class: normalizeClass([_ctx.$style.icon, _ctx.$style.icon_success, _ctx.$style.icon_right]),
                  size: _ctx.iconSize
                }, null, 8, ["class", "size"]))
              : createCommentVNode("", true),
            (_ctx.hasCleaner && _ctx.isValue)
              ? (openBlock(), createBlock(_component_svg_icon, {
                  ...
                  name: "close",
                  class: normalizeClass([_ctx.$style.closeIcon, _ctx.$style.icon, _ctx.$style.icon_right]),
                  size: _ctx.iconSize,
                  onClick: withModifiers(_ctx.clearSearch, ["stop","prevent"])
            ...
            (_ctx.hasRightSlot)
              ? (openBlock(), createElementBlock("div", {
                  ...
                  class: normalizeClass(_ctx.$style.icon_right)
                }, [
