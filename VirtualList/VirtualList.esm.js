import { defineComponent, toRefs, ref, computed, onMounted, onUpdated, onBeforeUnmount, openBlock, createElementBlock, renderSlot, onBeforeMount, watch, resolveComponent, normalizeClass, createVNode, withCtx, createElementVNode, normalizeStyle, Fragment, renderList, createBlock } from 'vue';
...
var script$1 = defineComponent({
    ...
    setup(props, ctx) {
        ...
        const shapeKey = computed(() => horizontal.value ? "offsetWidth" : "offsetHeight");
        onMounted(() => {
...
var script = defineComponent({
    ...
    setup(props, ctx) {
        const { dataKey, items, direction, start, offset, topThreshold, bottomThreshold, keeps, pageMode, } = toRefs(props);
        const range = ref({});
        const root = ref(null);
        ...
        const isHorizontal = computed(() => direction.value === Direction.HORIZONTAL);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", {
      role: "group",
      class: normalizeClass([_ctx.$style.group, _ctx.$style['group_' + _ctx.direction]]),
      style: normalizeStyle(_ctx.groupStyle)
    }, [
      (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.computedItems, (element) => {
        return (openBlock(), createBlock(_component_item, {
          ...
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "default", { item: element })
          ]),
          _: 2
        }, 1032, ["onItemResize"]))
      }), 128))
